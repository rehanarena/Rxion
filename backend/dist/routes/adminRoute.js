...
adminRouter.get("/reports", reportController_1.getAppointmentsReport);
adminRouter.get("/metrics", dashboardController_1.getTotal);
adminRouter.get("/revenue", dashboardController_1.getRevenue);
adminRouter.get("/appointments-status", dashboardController_1.getStatusAppointment);
adminRouter.get("/appointments-payment", dashboardController_1.getPaymentStatus);
adminRouter.get("/top-doctors", dashboardController_1.getTopDoctors);
